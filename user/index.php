...
if ($status_filter === 'all') {
    ...
    // Hide 'draft' and 'under_review' by default
    $query .= " AND o.status NOT IN ('draft', 'under_review')";
}
...
<div class="space-y-6 pb-20">
    ...
    <div class="flex justify-between items-start">
        <div>
            <h1 class="text-[32px] font-bold text-navy leading-tight">Ordinance Database</h1>
            <p class="text-sm text-on-surface-variant mt-1">
                Comprehensive repository of all municipal legislative records. Click any row to view the ordinance.
            </p>
        </div>
        <div class="flex items-center gap-3">
            <button onclick="exportData()" class="px-4 py-2 border border-outline-variant rounded text-xs font-bold text-navy hover:bg-surface-container transition-all">
                Export Data
            </button>
        </div>
    </div>
...
<div id="deleteModal" class="fixed inset-0 z-[120] hidden items-center justify-center p-6">
    ...
    <div
        ...
        <div class="p-8 text-center">
            ...
            <div
                class="inline-block px-3 py-1 bg-red-900/10 border border-red-900/30 rounded text-[11px] font-bold text-red-400 uppercase tracking-widest">
        ...
        <div class="px-8 py-6 bg-[#0d1117] border-t border-[#30363d] flex justify-center gap-4">
            ...
            <form action="../actions/delete.php" method="POST">
                ...
                <button type="submit"
                    class="px-8 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-bold transition-all shadow-lg">Confirm
                    Delete</button>
            </form>
        </div>
    </div>
...
<script>
    ...
    function openDrawer(ord) {
        ...
        document.getElementById('drawerFullViewBtn').href = `view.php?id=${ord.id}&view=full`;
        document.getElementById('drawerFullViewBtn2').href = `view.php?id=${ord.id}&view=full`;
